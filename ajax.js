...
function validId(val) {
    if (val ==1){
        ...
        document.getElementById('id_card_no').setAttribute('data-minlength','4');
        document.getElementById('id_card_no').setAttribute('placeholder',"1000140");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter  Valid National Identity Card No");
    }else if(val ==2){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','4');
        document.getElementById('id_card_no').setAttribute('placeholder',"CO2635100");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter  Valid student ID Card No");
    }else if(val ==3){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','4');
        document.getElementById('id_card_no').setAttribute('placeholder',"RKS17878A");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter  Valid  Card No");
    }else if(val == 4){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','4');
        document.getElementById('id_card_no').setAttribute('placeholder',"RJ29 20210040869");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter  Valid Licence Number");
    }
}
...
function fetch_Item_price(val) {
    var Item_type = $('#Item_type').val();
    $('#total_price').html(Item_type*val);
    $.ajax({
        type: 'post',
        url: 'ajax.php',
        data: {
